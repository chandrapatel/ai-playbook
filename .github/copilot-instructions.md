...
Detailed, scoped guidance is in:
- `.github/instructions/wordpress-php.instructions.md`
- `.github/instructions/wordpress-js.instructions.md`
- `.github/instructions/wordpress-css.instructions.md`
